...
export const metadata: Metadata = {
  title: "قوانین و مقررات استفاده از رزرویتو",
};
      ...
      <header className="border-b bg-neutral-50">
        <div className="container mx-auto px-6 py-10">
          <h1 className="text-3xl md:text-4xl font-extrabold">
            قوانین و مقررات استفاده از رزرویتو
          </h1>
          <p className="mt-4 text-neutral-600 max-w-3xl">
            استفاده از خدمات رزرویتو به منزله پذیرش کامل قوانین و مقررات زیر
      ...
      <section className="container mx-auto px-6 py-12 space-y-10 max-w-4xl">
        ...
        <div>
          ...
          <p className="leading-8 text-neutral-700">
            در این سند، منظور از «رزرویتو» سامانه آنلاین مدیریت و رزرو نوبت است
            و «کاربر» به هر شخص حقیقی یا حقوقی گفته می‌شود که از خدمات سامانه
            استفاده می‌کند.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="leading-8 text-neutral-700">
            ...
            تعرفه‌های اعلام‌شده هستند. رزرویتو مسئولیتی در قبال اختلافات مالی
        ...
        <div>
          ...
          <ul className="list-disc pr-6 space-y-2 text-neutral-700">
            <li>
              رزرویتو تنها بستر ارتباطی بین کاربران و کسب‌وکارها را فراهم
              می‌کند.
            </li>
            <li>مسئولیت کیفیت خدمات ارائه‌شده بر عهده کسب‌وکار مربوطه است.</li>
            <li>
              رزرویتو مسئول خسارات ناشی از قطعی اینترنت یا مشکلات فنی خارج از
              کنترل خود نیست.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="leading-8 text-neutral-700">
            در صورت نقض قوانین یا سوءاستفاده از سامانه، رزرویتو حق دارد بدون
        ...
        <div>
          ...
          <p className="leading-8 text-neutral-700">
            رزرویتو می‌تواند در هر زمان این قوانین را به‌روزرسانی کند. ادامه
        ...
        <div className="border-t pt-6 text-sm text-neutral-500">
          <p>
            ...
            صفحه «تماس با ما» با پشتیبانی رزرویتو ارتباط برقرار کنید.
          </p>
        </div>
      </section>
    </main>
