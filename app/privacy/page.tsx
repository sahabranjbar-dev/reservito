...
export const metadata: Metadata = {
  title: "حریم خصوصی کاربران | رزرویتو",
};
      ...
      <header className="border-b bg-neutral-50">
        <div className="container mx-auto px-6 py-10">
          ...
          <p className="mt-4 text-neutral-600 max-w-3xl">
            ما در «رزرویتو» متعهد به حفظ و حراست از اطلاعات شخصی کاربران هستیم.
            این صفحه توضیح می‌دهد چه اطلاعاتی جمع‌آوری می‌شود و چگونه از آن
            استفاده می‌کنیم.
          </p>
        </div>
      </header>
      ...
      <section className="container mx-auto px-6 py-12 space-y-10 max-w-4xl">
        ...
        <div className="border-t pt-6 text-sm text-neutral-500">
          <p>
            ...
            «تماس با ما» با پشتیبانی رزرویتو در ارتباط باشید.
          </p>
        </div>
      </section>
    </main>
